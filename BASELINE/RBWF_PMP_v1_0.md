...
ผู้จัดการโครงการจัดทำรายงานความคืบหน้าประจำเดือน (Project Status Report - PSR) ส่งให้ผู้มีอำนาจลงนามและคณะทำงานทุกสิ้นเดือน การประชุมติดตามความก้าวหน้า (Minutes of Meeting - MOM) จัดขึ้นเดือนละ 1 ครั้ง รายงาน PSR ประกอบด้วยหัวข้อดังนี้:
...
|---|---|---|---|---|
| R-01 | การเปลี่ยนแปลงขอบเขตความต้องการระหว่างพัฒนา | ใช้กระบวนการอนุมัติ Change Request (CR) อย่างเคร่งครัด และบันทึกใน CRR | 4 | 5 |
