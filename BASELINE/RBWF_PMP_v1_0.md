...
| 2 | 0.1 | ตรวจทาน แผนดำเนินโครงการ | นายวีระ เนียมโภคะ (TL) | 20 มกราคม พ.ศ. 2569 |
| 3 | 1.0 | อนุมัติเอกสาร แผนการดำเนินโครงการ | นายทิโนภาส อรไทวรรณ | 20 มกราคม พ.ศ. 2569 |
...
ผู้จัดการโครงการจัดทำรายงานความก้าวหน้า (Project Status Report - PSR) นำเสนอและลงนามในประชุมร่วมลูกค้าเดือนละ 1 ครั้ง โดยวันที่รายงาน PSR เป็นวันเดียวกับประชุมภายนอก การประชุมภายในทีมจัดก่อน 2 วันและหลัง 1 วันของแต่ละครั้งประชุมลูกค้า รายงาน PSR ประกอบด้วยหัวข้อดังนี้:
...
ติดตามสถานะ R-01 ถึง R-07 **ครบทุกรายการ** ในตารางประเมินความเสี่ยงของ MOM และ PSR แต่ละรอบ ความเสี่ยงที่พบใหม่ระหว่างเดือนบันทึกต่อท้ายตารางรอบนั้น และไม่แทนที่ทะเบียนเริ่มโครงการในเอกสารนี้
...
ไฟล์เอกสารขึ้นต้นด้วยชื่อย่อโครงการ `RBWF` ตามด้วยประเภทเอกสารและเวอร์ชัน เช่น `RBWF_PMP_v1_0.md` ระเบียนตามวันที่ใช้รูปแบบ `RBWF_MOM_YYYYMMDD.md`, `RBWF_PSR_YYYYMMDD.md`
...
| วันที่: 10 มกราคม พ.ศ. 2569 | วันที่: 20 มกราคม พ.ศ. 2569 | วันที่: 20 มกราคม พ.ศ. 2569 |
